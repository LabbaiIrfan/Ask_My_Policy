            ...
            >
                <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {errors.submit && (
                            <div
                                className={`mt-4 p-3 rounded-lg border ${errors.submit.includes("successfully") || errors.submit.includes("verify")
                                    ? "bg-green-50 border-green-200"
                                    : "bg-red-50 border-red-200"
                                    }`}
                            >
                                <p
                                    className={`text-sm ${errors.submit.includes("successfully") || errors.submit.includes("verify")
                                        ? "text-green-600"
                                        : "text-red-600"
                                        }`}
                                >
